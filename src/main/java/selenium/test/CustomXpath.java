...
public class CustomXpath {
	...
	public static void main(String[] args) {
		...
		// input[@name='firstname' and contains(@id,'firstname') and
		// contains(@placeholder,'First')]
		...
		// a[text()='Register']
		// p[text()='Freshworks makes it fast and easy for businesses to delight their
		...
		// a[contains(@href,'route=account/forgotten') and text()='Forgotten Password'
		// and @class='list-group-item']
		// a[contains(@href,'route=account/forgotten') and contains(text(),'Forgotten')
